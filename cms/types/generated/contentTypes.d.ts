...
export interface ApiBookRequestBookRequest extends Struct.CollectionTypeSchema {
  collectionName: 'book_requests';
  info: {
    displayName: 'Book Request';
    pluralName: 'book-requests';
    singularName: 'book-request';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<
      ['submitted', 'in_review', 'fulfilled', 'rejected']
    > &
      Schema.Attribute.Required &
...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    format: Schema.Attribute.Enumeration<['PDF', 'EPUB', 'Chm']>;
    ...
    sku: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    tableOfContents: Schema.Attribute.Component<'toc.line', true>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBrandingBranding extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dark: Schema.Attribute.Component<'branding.theme-tokens', false>;
    description: Schema.Attribute.Text;
    light: Schema.Attribute.Component<'branding.theme-tokens', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface PluginUsersPermissionsUser
  ...
  info: {
    description: 'PINNED MANUAL TRANSCRIPTION: this is a full copy of the built-in @strapi/plugin-users-permissions user schema (additions-only deep-merge did not work in this Strapi version) plus hospital/specialty/avatar/joinedDate. Re-sync the built-in attributes with node_modules/@strapi/plugin-users-permissions/dist/server/content-types/user/index.js whenever the plugin is upgraded.';
    displayName: 'User';
    name: 'user';
    pluralName: 'users';
    singularName: 'user';
  ...
  attributes: {
    ...
    hospital: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::book-request.book-request': ApiBookRequestBookRequest;
