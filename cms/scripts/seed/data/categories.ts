...
export const CATEGORIES_TREE: CategoryItem[] = [
  {
    ...
    children: [
      ...
      { id: "noi-than-kinh", name: "Nội thần kinh", slug: "noi-khoa/noi-than-kinh", count: 37 },
      {
        ...
        slug: "noi-khoa/di-ung-mien-dich",
        count: 18,
      },
      {
        id: "hoi-suc-cap-cuu",
        name: "Hồi sức – Cấp cứu – ICU",
        slug: "noi-khoa/hoi-suc-cap-cuu",
        count: 41,
      },
      {
        id: "huyet-hoc-truyen-mau",
        name: "Huyết học truyền máu",
        slug: "noi-khoa/huyet-hoc-truyen-mau",
        count: 24,
      },
    ],
  },
  {
    ...
    children: [
      {
        id: "giao-trinh-ngoai",
        name: "Giáo trình Ngoại",
        slug: "ngoai-khoa/giao-trinh-ngoai",
        count: 36,
      },
      {
        id: "ngoai-tong-quat",
        name: "Ngoại tổng quát",
        slug: "ngoai-khoa/ngoai-tong-quat",
        count: 54,
      },
      { id: "ngoai-cap-cuu", name: "Ngoại cấp cứu", slug: "ngoai-khoa/ngoai-cap-cuu", count: 42 },
      {
        id: "ngoai-tieu-hoa",
        name: "Ngoại tiêu hóa – Gan mật",
        slug: "ngoai-khoa/ngoai-tieu-hoa",
        count: 47,
      },
      {
        id: "ngoai-long-nguc",
        name: "Ngoại lồng ngực – Tim mạch",
        slug: "ngoai-khoa/ngoai-long-nguc",
        count: 35,
      },
      {
        id: "ngoai-mach-mau",
        name: "Ngoại mạch máu",
        slug: "ngoai-khoa/ngoai-mach-mau",
        count: 22,
      },
      {
        id: "ngoai-tiet-nieu",
        name: "Ngoại tiết niệu",
        slug: "ngoai-khoa/ngoai-tiet-nieu",
        count: 28,
      },
      {
        id: "ngoai-than-kinh",
        name: "Ngoại thần kinh – Sọ não",
        slug: "ngoai-khoa/ngoai-than-kinh",
        count: 39,
      },
      {
        id: "chan-thuong-chinh-hinh",
        name: "Chấn thương chỉnh hình",
        slug: "ngoai-khoa/chan-thuong-chinh-hinh",
        count: 58,
      },
  ...
  },
  {
    ...
    children: [
      {
        id: "giao-trinh-san-phu-khoa",
        name: "Giáo trình Sản phụ khoa",
        slug: "san-phu-khoa/giao-trinh-san-phu-khoa",
        count: 28,
      },
  ...
  },
  {
    ...
    children: [
      {
        id: "giao-trinh-nhi-khoa",
        name: "Giáo trình Nhi khoa",
        slug: "nhi-khoa/giao-trinh-nhi-khoa",
        count: 32,
      },
      { id: "noi-nhi", name: "Nội Nhi & Sơ sinh", slug: "nhi-khoa/noi-nhi", count: 124 },
      {
        id: "ngoai-nhi",
        name: "Ngoại Nhi & Dị tật bẩm sinh",
        slug: "nhi-khoa/ngoai-nhi",
        count: 54,
      },
    ],
  },
  {
    ...
    children: [
      ...
      { id: "da-lieu", name: "Da liễu & Thẩm mỹ da", slug: "chuyen-khoa-le/da-lieu", count: 51 },
      {
        id: "tai-mui-hong",
        name: "Tai Mũi Họng",
        slug: "chuyen-khoa-le/tai-mui-hong-chuyen-khoa-le",
        count: 48,
      },
      { id: "rang-ham-mat", name: "Răng Hàm Mặt", slug: "chuyen-khoa-le/rang-ham-mat", count: 39 },
      {
        id: "truyen-nhiem",
        name: "Truyền nhiễm & Bệnh nhiệt đới",
        slug: "chuyen-khoa-le/truyen-nhiem",
        count: 35,
      },
      { id: "ung-buou", name: "Ung bướu & Xạ trị", slug: "chuyen-khoa-le/ung-buou", count: 44 },
      {
        id: "tam-than",
        name: "Tâm thần & Tâm lý lâm sàng",
        slug: "chuyen-khoa-le/tam-than",
        count: 28,
      },
      {
        id: "gay-me-hoi-suc",
        name: "Gây mê hồi sức",
        slug: "chuyen-khoa-le/gay-me-hoi-suc",
        count: 33,
      },
      {
        id: "phuc-hoi-chuc-nang",
        name: "Phục hồi chức năng & Vật lý trị liệu",
        slug: "chuyen-khoa-le/phuc-hoi-chuc-nang",
        count: 20,
      },
    ],
  },
    ...
    children: [
      {
        ...
        slug: "can-lam-sang/chan-doan-hinh-anh",
        count: 110,
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "duoc-ly-hoc", name: "Dược lý học", slug: "y-hoc-co-so/duoc-ly-hoc", count: 55 },
      {
        id: "giai-phau-benh",
        name: "Giải phẫu bệnh",
        slug: "y-hoc-co-so/giai-phau-benh",
        count: 38,
      },
      {
        id: "ky-nang-lam-sang",
        name: "Kỹ năng lâm sàng",
        slug: "y-hoc-co-so/ky-nang-lam-sang",
        count: 41,
      },
      {
        id: "vi-sinh-ky-sinh-trung",
        name: "Vi sinh – Ký sinh trùng",
        slug: "y-hoc-co-so/vi-sinh-ky-sinh-trung",
        count: 36,
      },
    ],
  },
